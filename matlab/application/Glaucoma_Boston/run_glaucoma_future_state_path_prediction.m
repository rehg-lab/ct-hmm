...
CTHMM_model_dir = 'output_vis_minvisit5_statedef2/age_0_120/CV_1/Iter_18';
CTHMM_learn_load_para(CTHMM_model_dir);
top_out_folder = 'output_predict_future_state_path';
...
mkdir(out_dir);
vis_threshold = 0.000001;
for future_year = 5:5:20  % every 5 years, until 20 years
...
% future_month = 20 * 12.0; % future 20 years
